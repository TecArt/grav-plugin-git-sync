...
**Git Sync** is a Fork of the [GitSync](https://github.com/trilbymedia/grav-plugin-git-sync) Plugin for [Grav CMS](http://github.com/getgrav/grav) that allows to seamlessly synchronize a Git repository with your Grav site, and vice-versa.
